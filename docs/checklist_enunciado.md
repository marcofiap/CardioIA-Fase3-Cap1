...
| Minimo de 2 sensores distintos | Atendido | DHT22 e botao de pulso em `src/wokwi/diagram.json` |
...
| Relatorio minimo de uma pagina | Atendido | `docs/relatorio_parte1_edge.md` |
...
| Indicador visual de alerta | Atendido | `ui_text` e LED virtual em `ui_template` |
| Prints ou export do dashboard | Parcial | Export incluido; faltam prints reais em `assets/evidencias/` |
| Relatorio minimo de duas paginas | Atendido | `docs/relatorio_parte2_mqtt_dashboard.md` |
...
| Classificador tradicional | Atendido | Regressao logistica |
| Rede/modelo neuromorfico simples | Atendido | LIF simples |
| Relatorio comparativo | Atendido | `docs/relatorio_ir_alem2_ia_series_temporais.md` |
